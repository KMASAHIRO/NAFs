...
save_name = os.path.join(cur_args.result_output_dir, "pyroomacoustics_train_data_NAF.pkl")# +"dual_grid1"
...
with open("./results/inference_wav/" + "pyroomacoustics_train_data_NAF.pkl", mode="wb") as f:
