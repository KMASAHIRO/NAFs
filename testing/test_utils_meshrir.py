...
#    final_container = []
#    try:
#        true = pyroomacoustics.experimental.measure_rt60(true_in, fs=22050, decay_db=30)
#        left_gen = pyroomacoustics.experimental.measure_rt60(gen_in, fs=22050, decay_db=30)
#    except:
#        true = -1
#        gen = -1
#    to_return = [true, gen]
...
def compute_t60(true_in, gen_in):
    ...
    try:
        true = pyroomacoustics.experimental.measure_rt60(true_in, fs=22050, decay_db=30)
        gen = pyroomacoustics.experimental.measure_rt60(gen_in, fs=22050, decay_db=30)
...
def get_wave_1(input_stft, input_if):
    # 1 chanel input of shape [1,freq,time]
